  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        <h3 className="text-lg font-medium text-[#1f2a44]">Select Your Headrail</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {options.map((option) => (
          <button
            ...
            className={`relative border rounded-[12px] p-4 transition-all hover:border-[#b8c7df] ${selectedHeadrail === option.id
          ...
          >
            ...
            {option.image && (
              <div
                className="relative h-[140px] w-full mb-3 bg-[#e7eef8] rounded overflow-hidden cursor-zoom-in"
