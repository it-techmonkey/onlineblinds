            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {options.map((option) => (
                    <button
                        ...
                        className={`relative border rounded-[12px] p-4 transition-all hover:border-[#b8c7df] text-center ${selectedOption === option.id
                    ...
                    >
                        ...
                        {option.image && (
                            <div
                                className="relative h-[100px] w-full mb-3 bg-[#e7eef8] rounded overflow-hidden flex items-center justify-center cursor-zoom-in"
