            ...
            <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                ...
                <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
                    <div className="flex w-full max-w-[600px] text-xs md:text-base font-medium text-center">
                        ...
                        {/* Online Blinds Column (Dark Card) */}
                        <div className="w-[110px] sm:w-[130px] md:w-[200px] bg-[#1f2a44] text-white rounded-2xl shadow-2xl z-20 relative -my-4 pb-4 flex flex-col items-center">
                            <div className="h-[88px] flex items-center justify-center w-full border-b border-white/10 px-2">
                                <span className="text-white font-bold text-sm md:text-lg tracking-wide leading-tight">Online Blinds</span>
                            </div>
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
                    ...
                    <button
                        onClick={scrollToTop}
                        className="bg-[#1f2a44] text-white px-8 py-3.5 rounded-lg hover:bg-gray-800 transition-colors font-semibold"
                    >
