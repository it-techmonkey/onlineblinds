    ...
    <section className="bg-white py-12 md:py-16 lg:py-24 overflow-hidden">
      <div className="flex flex-col gap-8 md:gap-[41px] items-center">
        <div className="w-full flex items-center justify-between px-4 md:px-6 lg:px-20">
          <h2 className="text-xl md:text-2xl lg:text-[32px] font-medium text-[#25344d] tracking-tight">
            Popular Categories
          </h2>
          <div className="hidden lg:flex gap-3">
            <button
              ...
              className="w-10 h-10 rounded-full border border-[#25344d] flex items-center justify-center hover:bg-[#335c99] hover:border-[#335c99] hover:text-white transition-colors"
            >
          ...
          <div className="flex gap-4 md:gap-6 h-[350px] md:h-[420px] items-center pl-4 md:pl-6 lg:pl-20">
            {categories.map((category) => (
              ...
              >
                ...
                <h3 className="text-sm md:text-base lg:text-lg font-medium text-[#25344d] text-center w-full">
                  {category.name}
                </h3>
              </a>
            ))}
